    ...
    public partial class Form3 : Form
    {
        ...
        private void Customer_Load(object sender, EventArgs e)
        {
            ...
            if (checks == true)
            {
                ...
                //criteria
                List<AdminCriteria> listReview = ac.CriteriaList("D:\\NET centric code\\WindowsFormsApp1\\him.txt");
            ...
            else
            {
                ...
                //for default Rating
                List<AdminRating> listReviews = af.RatingList("D:\\NET centric code\\WindowsFormsApp1\\him1.txt");
                ...
                List<AdminCriteria> listReview = ac.CriteriaList("D:\\NET centric code\\WindowsFormsApp1\\him2.txt");
                PropertyDescriptorCollection properties = TypeDescriptor.GetProperties(typeof(AdminCriteria));
